<?php
    ...
    if(!empty($nom) && !empty($prenom) && !empty($email) && !empty($password)){
                            ...
                            if(move_uploaded_file($tmp_name,"images/".$new_img_name)){
                                ...
                                if($insert_query){
                                    ...
                                    if(mysqli_num_rows($select_sql2) > 0){
                                        ...
                                        echo "Cet adresse email n'existe pas!";
                                    }
                                }else{
                                    echo "Un problème est survenu, veuillez reessayer plus tard";
                                }
                            }
                        }else{
                            echo "Uniquement les fichiers suivants sont acceptés - jpeg, png, jpg";
                        }
                    }else{
                        echo "Uniquement les fichiers suivants sont acceptés - jpeg, png, jpg";
                    }
        ...
        echo "Vous devrez remplir tous les champs!";
    }
?>